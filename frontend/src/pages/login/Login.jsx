    ...
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto ">
        <div className="w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0" >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Link to="/signup" className="text-sm  text-gray-600 hover:underline hover:text-green-600 mt-2 inline-block">{"Don't"} have an Account?</Link>
            <div>
...
//               </input>
//               </div>
//               <a href="#" className="text-sm  text-gray-600 hover:underline hover:text-green-600 mt-2 inline-block">{"Don't"} have an Account?</a>
//               <div>
